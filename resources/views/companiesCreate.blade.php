...
<div>
    ...
    <form action="{{ route('admin.companies.store') }}" class="signin-form" method="post">
        ...
        <input class="form-control" type="text" name="commercialName" placeholder="Nombre comercial" required>
        <br>
        <input class="form-control" type="text" name="razonSocial" placeholder="Razón social" required>
        <br>
        <input class="form-control" type="text" name="ruc" placeholder="RUC" pattern="[0-9]{11}" maxlength="11" required>
        <br>
        ...
        <br>
        <input class="form-control" type="text" name="company" placeholder="Empresa" required>
        <br>
        <input class="form-control" type="text" name="role" placeholder="Rol" required>
        <br>
        ...
        <br><br>
        <select class="custom-select rounded-0" name="id_country" required>
